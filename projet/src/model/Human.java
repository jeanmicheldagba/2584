...
import static model.Parametres.TOUCHE_B_1;
import static model.Parametres.TOUCHE_D_1;
import static model.Parametres.TOUCHE_G_1;
import static model.Parametres.TOUCHE_H_1;
import static model.Parametres.TOUCHE_UNDO;
    ...
    public void jouer(){
        ...
        while (!this.g.bloquee()) {
            ...
            if (!(s.equals(TOUCHE_D_1) || s.equals(TOUCHE_G_1) || s.equals(TOUCHE_H_1) || s.equals(TOUCHE_B_1) || s.equals(TOUCHE_UNDO))) {
                ...
                if (b2) {
                    if (!this.g.nouvelleCase()) this.gameOver();
                }
